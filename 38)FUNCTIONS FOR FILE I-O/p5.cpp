...
User *create_node_user(User *current)
{
    User *n;
    ...
    cin >> shoeSize;
    n = new User(idNum1, idNum2, name, age, height, gender, shoeSize);
    n->next = NULL;
    current->next = n;
    return n;
}
...
Shoe *create_node_shoe(Shoe *current)
{
    Shoe *n;
    double size, width;
    string style, brand, color, demographic;
    ...
    n = new Shoe(size, width, style, brand, color, demographic);
    n->next = NULL;
    current->next = n;
    return n;
}
...
{
    User *headUser;
    headUser = new User(22, 1234, "abd", 12, 32, "male", 32);
    headUser->next = NULL;
    User *currentUser;
    currentUser = headUser;

    Shoe *headShoe;
    headShoe = new Shoe(12, 23, "shoes", "stylo", "red", "toddler");
    headShoe->next = NULL;
    Shoe *currentShoe;
    currentShoe = headShoe;
        ...
        case 1:
            ...
            while (flag1)
            {
                ...
                case 1:
                    ...
                    currentUser = create_node_user(currentUser);
                    break;
        ...
        case 2:
            ...
            while (flag1)
            {
                ...
                case 1:
                    ...
                    currentShoe = create_node_shoe(currentShoe);
                    break;
                case 2:
